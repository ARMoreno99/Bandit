...
def BANDIT(level : str, user : str, password : str, command : str, command_local : str):
...
def bandit_12(level : str, user : str, password : str):
    ...
    os.system("sshpass -p " + password + " scp -q -P " + port + " " + user + "@" + host + ":data.txt " + path + " && wget -q https://raw.githubusercontent.com/ARMoreno99/OverTheWire/main/BANDIT/scripts/decompress.sh  && /bin/bash decompress.sh data.txt >>" + file_flag)
...
if __name__ == '__main__':
    ...
    banner()
    #USE = BANDIT("LEVEL", "USER", "", "COMMAND", "COMMAND_LOCAL")
    ...
    # TODO: Modificar BANDIT para optimizar los niveles "especiales" o Intentar ajustarlo a BANDIT
    bandit_12("12", "bandit12", "JVNBBFSmZwKKOP0XbFXOoW8chDz5yVRv") 
